...
This capability provides listing of checkpoint files with formatted display, filtering by server/campaign, and efficient metadata reading from checkpoint archives.
