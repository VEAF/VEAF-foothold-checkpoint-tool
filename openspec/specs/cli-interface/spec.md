...
This capability provides the command-line interface for all checkpoint operations. It includes Typer-based CLI with commands for save/restore/list/delete/import, Rich formatting for output, interactive prompts, and flag validation.
