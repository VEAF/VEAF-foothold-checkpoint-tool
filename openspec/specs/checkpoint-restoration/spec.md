...
This capability provides restoration of checkpoint files to server directories. It includes file integrity verification, cross-server restoration, file renaming for campaign evolution, and overwrite confirmation.
