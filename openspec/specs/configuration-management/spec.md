...
This capability provides YAML-based configuration loading and validation using Pydantic models. It includes server definitions, campaign name mappings, checkpoint storage location, and auto-creation of default configuration.
