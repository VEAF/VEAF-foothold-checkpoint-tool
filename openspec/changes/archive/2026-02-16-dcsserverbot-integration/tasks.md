...
- [x] 3.12 Add aiofiles dependency for async file operations (optional optimization)
- [x] 3.13 Update all core tests to use asyncio.run() or @pytest.mark.asyncio
...
- [x] 4.8 Add tests for auto-backup creation and failure scenarios
...
- [x] 18.6 Include README.md with installation instructions
- [x] 18.7 Output ZIP to dist/foothold-plugin-v2.0.0.zip
- [x] 18.8 Test ZIP extraction and structure
- [x] 18.9 Update CI/CD to run build_plugin.py on release
...
- [x] 24.1 Create README.md in plugin folder
...
- [x] 26.1 Update CHANGELOG.md with v2.0.0 entry
- [x] 26.2 Document all added features (Discord integration)
- [x] 26.3 Document all changed features (async core, campaigns.yaml)
- [x] 26.4 Document breaking changes prominently
- [x] 26.5 Add migration guide reference
- [x] 26.6 Update RELEASE_NOTES.md with v2.0.0 section
- [x] 26.7 Include Discord command examples in release notes
- [x] 26.8 Document quality metrics (test count, coverage)
- [x] 26.9 Add upgrade instructions
...
- [x] 28.1 Update GitHub Actions workflow for v2.0.0
- [x] 28.2 Add plugin build step to CI pipeline
- [x] 28.3 Test both CLI-only and full install in CI
- [x] 28.4 Run tests with and without plugin dependencies
- [x] 28.5 Build plugin ZIP on release
- [x] 28.6 Upload plugin ZIP as release asset
- [x] 28.7 Verify Discord dependency is optional
...
- [x] 30.5 Verify code coverage >90%
- [x] 30.6 Run mypy type checking (no errors)
- [x] 30.7 Run black formatting
- [x] 30.8 Run ruff linting
- [x] 30.9 Build package with poetry build
- [x] 30.10 Build plugin ZIP with build_plugin.py
